...
_STOPWORDS: frozenset[str] = frozenset({
    ...
    "кислотой", "кислот", "кислотах", "кислотам", "кислотами",
    "кислотный", "кислотная", "кислотное", "кислотной", "кислотного",
    "кислотных", "кислотные", "кислотным", "кислотными",
    "спирт", "спирта", "спирте",
    "жидкость", "жидкости",
    "смесь", "смеси",
    ...
    # Фармацевтические описательные слова
    "лекарственные", "лекарственных", "лекарственного", "лекарственной",
    "лекарственную", "лекарственным", "лекарственными",
    "формы", "форма", "форму", "форме", "формах", "формам",
    "препарат", "препараты", "препаратов", "препарата", "препарате",
    "средство", "средства", "средству", "средстве", "средством",
    "производные", "производных", "производного", "производному",
    "аналоги", "аналогов", "аналога", "аналогу",
    "применение", "применения", "применению", "применении",
    # Местоимения, союзы, наречия — не могут быть названиями веществ
    "другие", "другой", "другая", "другое", "другого", "другому",
    "некоторые", "некоторый", "различные", "различный",
    "также", "кроме", "после", "перед", "между",
    "которые", "которых", "которому", "которой",
    "этого", "этому", "этими",
    "иные", "прочие", "данные", "данный",
    # Общие химические термины — не идентифицируют конкретное вещество
    "водород", "водорода", "водороду", "водородом", "водороде",
    "водородных", "водородные", "водородный", "водородная",
    "кислород", "кислорода", "кислороду", "кислородом",
    "азот", "азота", "азоту", "азотом",
    "углерод", "углерода", "углероду", "углеродом",
    "фтор", "фтора", "фтору", "фтором",
    "хлор", "хлора", "хлору", "хлором",
    "сера", "серы", "сере", "серу", "серой",
    # English generic words
    "acid", "acids", "acidic", "acidity",
    "base", "salt", "oxide", "chloride", "sulfate", "nitrate",
    "solution", "mixture", "extract", "powder", "liquid",
    "sodium", "potassium", "calcium", "magnesium", "barium", "zinc",
    "hydrogen", "oxygen", "nitrogen", "carbon", "fluorine", "sulfur",
    "synthetic", "medical", "technical",
    "other", "others", "various", "some", "certain", "similar",
})
